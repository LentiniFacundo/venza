...
const NavBar = () => {
  ...
  return (
    <nav className='flex flex-row justify-start sm:justify-center sm:w-full m-2'>
      <section className='fixed top-0.5 right-0.5 mr-5 sm:hidden border-2 rounded-sm border-primary p-1 cursor-pointer' onClick={toggleMenu}>
        ...
        <ul className={`flex flex-col sm:flex-row gap-4 text-left sm:flex ${isOpen || 'hidden'}`}>
            ...
            text-gray-400 hover:text-primary transition-colors' href="">Inicio</a></li>
            <li><a className='text-xs font-bold tracking-widest uppercase 
            text-gray-400 hover:text-primary transition-colors' href="">Servicios</a></li>
            <li><a className='text-xs font-bold tracking-widest uppercase 
